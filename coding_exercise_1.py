#Take the following time slots in each tuple.  If there is overlap between two of the tuples make
# a condensed version of this list of tuples so that only unique meetings with no overlap can be determined.
